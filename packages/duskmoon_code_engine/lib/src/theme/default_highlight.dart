...
final HighlightStyle defaultLightHighlight = HighlightStyle([
  TagStyle(Tag.keyword, const TextStyle(color: Color(0xFF0000FF), fontWeight: FontWeight.bold)),
  TagStyle(Tag.string, const TextStyle(color: Color(0xFFA31515))),
  TagStyle(Tag.comment, const TextStyle(color: Color(0xFF008000), fontStyle: FontStyle.italic)),
  ...
  TagStyle(Tag.invalid, const TextStyle(color: Color(0xFFFF0000), decoration: TextDecoration.lineThrough)),
]);

final HighlightStyle defaultDarkHighlight = HighlightStyle([
  TagStyle(Tag.keyword, const TextStyle(color: Color(0xFF569CD6), fontWeight: FontWeight.bold)),
  TagStyle(Tag.string, const TextStyle(color: Color(0xFFCE9178))),
  TagStyle(Tag.comment, const TextStyle(color: Color(0xFF6A9955), fontStyle: FontStyle.italic)),
  ...
  TagStyle(Tag.meta, const TextStyle(color: Color(0xFF808080))),
  TagStyle(Tag.annotation_, const TextStyle(color: Color(0xFF808080))),
  TagStyle(Tag.invalid, const TextStyle(color: Color(0xFFF44747), decoration: TextDecoration.lineThrough)),
]);
