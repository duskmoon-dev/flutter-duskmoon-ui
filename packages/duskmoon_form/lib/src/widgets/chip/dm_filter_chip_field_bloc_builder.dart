...
import 'chip_field_item_builder.dart';

/// [FilterChip]
class DmFilterChipFieldBlocBuilder<T> extends StatelessWidget {
  ...
  const DmFilterChipFieldBlocBuilder({
    super.key,
  ...
  Widget build(BuildContext context) {
    ...
    final current = DmSimpleFieldBlocBuilder(
