...
import 'package:duskmoon_settings/src/tiles/checkbox_group/cupertino_checkbox_group_tile.dart';
import 'package:duskmoon_settings/src/tiles/input/cupertino_input_tile.dart';
import 'package:duskmoon_settings/src/tiles/radio_group/cupertino_radio_group_tile.dart';
import 'package:duskmoon_settings/src/tiles/select/cupertino_select_tile.dart';
import 'package:duskmoon_settings/src/tiles/slider/cupertino_slider_tile.dart';
import 'package:duskmoon_settings/src/tiles/textarea/cupertino_textarea_tile.dart';
    ...
    return ClipRRect(
      borderRadius: BorderRadius.vertical(
        top: additionalInfo.enableTopBorderRadius
            ? const Radius.circular(CupertinoSettingsTile._cornerRadius)
            : Radius.zero,
...
class CupertinoSettingsTileAdditionalInfo extends InheritedWidget {
  ...
  const CupertinoSettingsTileAdditionalInfo({
  ...
  static CupertinoSettingsTileAdditionalInfo of(BuildContext context) {
    final CupertinoSettingsTileAdditionalInfo? result =
