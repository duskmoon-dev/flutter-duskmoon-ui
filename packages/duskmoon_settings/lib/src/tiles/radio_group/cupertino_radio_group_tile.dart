...
/// Cupertino (iOS/macOS) radio group tile implementation.
///
/// Provides a group of radio options with iOS/macOS styling using checkmarks.
class CupertinoRadioGroupTile extends StatelessWidget {
  const CupertinoRadioGroupTile({
    required this.title,
