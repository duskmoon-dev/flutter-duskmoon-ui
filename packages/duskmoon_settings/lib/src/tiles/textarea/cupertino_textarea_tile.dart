...
/// Cupertino (iOS/macOS) textarea tile implementation.
///
/// Provides a multi-line text field with iOS/macOS styling using CupertinoTextField.
class CupertinoTextareaTile extends StatelessWidget {
  const CupertinoTextareaTile({
    required this.title,
    ...
    Widget content = Container(
      ...
      child: Column(
        ...
        children: [
          ...
          CupertinoTextField(
            controller: TextEditingController(text: textareaValue),
            onChanged: enabled ? onTextareaChanged : null,
            enabled: enabled,
            maxLines: textareaMaxLines,
            maxLength: textareaMaxLength,
            placeholder: textareaHint,
