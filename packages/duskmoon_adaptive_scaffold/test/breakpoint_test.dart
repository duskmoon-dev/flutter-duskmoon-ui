...
void main() {
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      expect(
        find.byKey(const Key('Breakpoints.mediumLargeDesktop')),
        findsNothing,
      );
      ...
      expect(
        find.byKey(const Key('Breakpoints.extraLargeDesktop')),
        findsNothing,
      );
    },
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpAndSettle();
      expect(
        find.byKey(const Key('Breakpoints.mediumDesktop')),
        findsOneWidget,
      );
  ...
  group('maybeActiveBreakpointFromSlotLayout', () {
    testWidgets(
      'returns correct breakpoint from SlotLayout on mobile devices',
      (WidgetTester tester) async {
    ...
    testWidgets(
      'returns correct breakpoint from SlotLayout on desktop devices',
      (WidgetTester tester) async {
  ...
  group('defaultBreakpointOf', () {
    testWidgets(
      'returns correct default breakpoint on mobile devices',
      (WidgetTester tester) async {
        // Small layout on mobile.
        await tester.pumpWidget(SimulatedLayout.small.slot(tester));
        await tester.pumpAndSettle();
        expect(
          Breakpoint.defaultBreakpointOf(tester.element(find.byType(Theme))),
          Breakpoints.smallMobile,
        );
    ...
    testWidgets(
      'returns correct default breakpoint on desktop devices',
      (WidgetTester tester) async {
        // Small layout on desktop.
        await tester.pumpWidget(SimulatedLayout.small.slot(tester));
        await tester.pumpAndSettle();
  ...
  group('activeBreakpointOf', () {
    testWidgets(
      'returns correct active breakpoint on mobile devices',
      (WidgetTester tester) async {
        // Small layout on mobile.
        await tester.pumpWidget(SimulatedLayout.small.slot(tester));
        await tester.pumpAndSettle();
    ...
    testWidgets(
      'returns correct active breakpoint on desktop devices',
      (WidgetTester tester) async {
        // Small layout on desktop.
        await tester.pumpWidget(SimulatedLayout.small.slot(tester));
        await tester.pumpAndSettle();
  ...
  group('Landscape Layout Tests', () {
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        await tester.pumpAndSettle();
        expect(
          find.byKey(const Key('Breakpoints.mediumMobile')),
          findsOneWidget,
        );
        expect(
          find.byKey(const Key('Breakpoints.mediumDesktop')),
        ...
        await tester.pumpWidget(
          SimulatedLayout.mediumLargeLandscape.slot(tester),
        );
        await tester.pumpAndSettle();
        expect(
          find.byKey(const Key('Breakpoints.mediumLargeMobile')),
        ...
        await tester.pumpAndSettle();
        expect(
          find.byKey(const Key('Breakpoints.largeMobile')),
          findsOneWidget,
        );
        expect(find.byKey(const Key('Breakpoints.largeDesktop')), findsNothing);
        ...
        await tester.pumpWidget(
          SimulatedLayout.extraLargeLandscape.slot(tester),
        );
        await tester.pumpAndSettle();
        expect(
          find.byKey(const Key('Breakpoints.extraLargeMobile')),
    ...
    testWidgets(
      'Mobile breakpoints do not show on desktop device (landscape)',
      (WidgetTester tester) async {
        // Small landscape layout on a desktop device.
        await tester.pumpWidget(SimulatedLayout.smallLandscape.slot(tester));
        await tester.pumpAndSettle();
        expect(
          find.byKey(const Key('Breakpoints.smallDesktop')),
          findsOneWidget,
        );
        expect(find.byKey(const Key('Breakpoints.smallMobile')), findsNothing);
        ...
        await tester.pumpAndSettle();
        expect(
          find.byKey(const Key('Breakpoints.largeDesktop')),
          findsOneWidget,
        );
        expect(find.byKey(const Key('Breakpoints.largeMobile')), findsNothing);
  ...
  group('Slot And Up Layout Tests', () {
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        await tester.pumpWidget(
          SimulatedLayout.mediumLandscape.slotAndUp(tester),
        );
        await tester.pumpAndSettle();
        expect(
          find.byKey(const Key('Breakpoints.mediumAndUp')),
          findsOneWidget,
        );
        expect(find.byKey(const Key('Breakpoints.small')), findsNothing);
        ...
        await tester.pumpWidget(
          SimulatedLayout.mediumLargeLandscape.slotAndUp(tester),
        );
        await tester.pumpAndSettle();
        expect(
          find.byKey(const Key('Breakpoints.mediumAndUp')),
        ...
        await tester.pumpWidget(
          SimulatedLayout.largeLandscape.slotAndUp(tester),
        );
        await tester.pumpAndSettle();
        expect(
          find.byKey(const Key('Breakpoints.mediumAndUp')),
        ...
        await tester.pumpWidget(
          SimulatedLayout.extraLargeLandscape.slotAndUp(tester),
        );
        await tester.pumpAndSettle();
        expect(
          find.byKey(const Key('Breakpoints.mediumAndUp')),
  ...
  group('spacing property', () {
    ...
    testWidgets(
      'returns kMaterialMediumAndUpSpacing for medium breakpoint',
      (WidgetTester tester) async {
        await tester.pumpWidget(SimulatedLayout.medium.slot(tester));
        await tester.pumpAndSettle();
        expect(
    ...
    testWidgets(
      'returns kMaterialMediumAndUpSpacing for large breakpoint',
      (WidgetTester tester) async {
        await tester.pumpWidget(SimulatedLayout.large.slot(tester));
        await tester.pumpAndSettle();
        expect(
    ...
    testWidgets(
      'returns kMaterialMediumAndUpSpacing for extraLarge breakpoint',
      (WidgetTester tester) async {
        await tester.pumpWidget(SimulatedLayout.extraLarge.slot(tester));
        await tester.pumpAndSettle();
        expect(
  ...
  group('margin property', () {
    testWidgets(
      'returns kMaterialCompactMargin for small breakpoint',
      (WidgetTester tester) async {
        await tester.pumpWidget(SimulatedLayout.small.slot(tester));
        await tester.pumpAndSettle();
        expect(
    ...
    testWidgets(
      'returns kMaterialMediumAndUpMargin for medium breakpoint',
      (WidgetTester tester) async {
        await tester.pumpWidget(SimulatedLayout.medium.slot(tester));
        await tester.pumpAndSettle();
        expect(
    ...
    testWidgets(
      'returns kMaterialMediumAndUpMargin for mediumLarge breakpoint',
      (WidgetTester tester) async {
        await tester.pumpWidget(SimulatedLayout.mediumLarge.slot(tester));
        await tester.pumpAndSettle();
        expect(
    ...
    testWidgets(
      'returns kMaterialMediumAndUpMargin for large breakpoint',
      (WidgetTester tester) async {
        await tester.pumpWidget(SimulatedLayout.large.slot(tester));
        await tester.pumpAndSettle();
        expect(
    ...
    testWidgets(
      'returns kMaterialMediumAndUpMargin for extraLarge breakpoint',
      (WidgetTester tester) async {
        await tester.pumpWidget(SimulatedLayout.extraLarge.slot(tester));
        await tester.pumpAndSettle();
        expect(
  ...
  group('padding property', () {
    testWidgets(
      'returns kMaterialPadding for small breakpoint',
      (WidgetTester tester) async {
        await tester.pumpWidget(SimulatedLayout.small.slot(tester));
        await tester.pumpAndSettle();
        expect(
    ...
    testWidgets(
      'returns kMaterialPadding * 2 for medium breakpoint',
      (WidgetTester tester) async {
        await tester.pumpWidget(SimulatedLayout.medium.slot(tester));
        await tester.pumpAndSettle();
        expect(
    ...
    testWidgets(
      'returns kMaterialPadding * 3 for mediumLarge breakpoint',
      (WidgetTester tester) async {
        await tester.pumpWidget(SimulatedLayout.mediumLarge.slot(tester));
        await tester.pumpAndSettle();
        expect(
    ...
    testWidgets(
      'returns kMaterialPadding * 4 for large breakpoint',
      (WidgetTester tester) async {
        await tester.pumpWidget(SimulatedLayout.large.slot(tester));
        await tester.pumpAndSettle();
        expect(
    ...
    testWidgets(
      'returns kMaterialPadding * 5 for extraLarge breakpoint',
      (WidgetTester tester) async {
        await tester.pumpWidget(SimulatedLayout.extraLarge.slot(tester));
        await tester.pumpAndSettle();
        expect(
  ...
  group('recommendedPanes property', () {
    ...
    testWidgets(
      'returns 2 for mediumLarge breakpoint',
      (WidgetTester tester) async {
        await tester.pumpWidget(SimulatedLayout.mediumLarge.slot(tester));
        await tester.pumpAndSettle();
        expect(
    ...
    testWidgets(
      'returns 2 for extraLarge breakpoint',
      (WidgetTester tester) async {
        await tester.pumpWidget(SimulatedLayout.extraLarge.slot(tester));
        await tester.pumpAndSettle();
        expect(
  ...
  group('maxPanes property', () {
    ...
    testWidgets(
      'returns 3 for extraLarge breakpoint',
      (WidgetTester tester) async {
        await tester.pumpWidget(SimulatedLayout.extraLarge.slot(tester));
        await tester.pumpAndSettle();
        expect(
  ...
  group('Breakpoint method tests', () {
    testWidgets(
      'isMobile returns true on mobile platforms',
      (WidgetTester tester) async {
        await tester.pumpWidget(SimulatedLayout.medium.scaffold(tester));
        await tester.pumpAndSettle();

        expect(
          Breakpoint.isMobile(tester.element(find.byType(TestScaffold))),
          isTrue,
        );

        expect(
          Breakpoint.isDesktop(tester.element(find.byType(TestScaffold))),
          isFalse,
        );
      },
      variant: TargetPlatformVariant.mobile(),
    ...
    testWidgets(
      'isDesktop returns true on desktop platforms',
      (WidgetTester tester) async {
        await tester.pumpWidget(SimulatedLayout.medium.scaffold(tester));
        await tester.pumpAndSettle();
