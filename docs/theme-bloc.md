...
**Persisted keys:**
- `dm_theme_name` — theme entry name string (e.g., `'duskmoon'` or `'ecotone'`)
...
`DmThemeEvent` is the sealed base class for the public events `DmSetTheme` and `DmSetThemeMode`.
